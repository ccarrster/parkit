;(function ($, window, document, undefined) {
  var pluginName = "countdown360",
    defaults = {
      ...
      strokeStyle: "#3d6041",          // the color of the stroke
      strokeWidth: undefined,          // the stroke width, dynamically calulated if omitted in options
      fillStyle: "#45b657",            // the fill color
      ...
      label: ["minute", "minutes"],    // the label to use or false if none
  ...
  Plugin.prototype = {
    ...
    _drawCountdownLabel: function (secondsElapsed) {
      ...
      var secondsLeft = Math.round(this._secondsLeft(secondsElapsed) / 60),
